...
void sm3_long_to_str(unsigned long a,unsigned char*b){
    unsigned long x=a;
...
void sm3_group_a(unsigned char*a,unsigned char*b,unsigned char*c,unsigned char*d,unsigned char*e,unsigned char*f){
    unsigned long x[6]={0};
...
void sm3_group_b(unsigned char*a, unsigned char*b, unsigned char*c){
    unsigned long x[3]={0};
    x[0]=sm3_str_to_long(a);
    x[1]=sm3_str_to_long(b);
    x[2]=P3(x[0],x[1]);
...
void sm3_str_summ(unsigned char*str,unsigned char*summ,int len){
